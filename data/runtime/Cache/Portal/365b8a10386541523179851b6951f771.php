<?php if (!defined('THINK_PATH')) exit();?> <!--//文章列表页瀑布流模板-->
...
<!-- Le javascript
 ...
 <script src="/cmfx/tpl/simplebootx/Public/js/imagesloaded.pkgd.min.js"></script>
    <script src="/cmfx/tpl/simplebootx/Public/js/masonry.pkgd.min.js"></script>
	<script>
