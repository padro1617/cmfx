<?php if (!defined('THINK_PATH')) exit();?>  <!--//文章列表页模板-->
...
<head>
    ...
    <![endif]-->
	<link rel="icon" href="/cmfx/tpl/simplebootx/Public/images/favicon.ico" type="image/x-icon">
	<link rel="shortcut icon" href="/cmfx/tpl/simplebootx/Public/images/favicon.ico" type="image/x-icon">
...
<div class="navbar navbar-fixed-top">
   <div class="navbar-inner">
     <div class="container">
       ...
       <a class="brand" href="/cmfx/"><img src="/cmfx/tpl/simplebootx/Public/images/logo.png"/></a>
 ...
 $effected_id=""; $filetpl="<a href='\$href' target='\$target'>\$label</a>"; $foldertpl="<a href='\$href' target='\$target' class='dropdown-toggle' data-toggle='dropdown'>\$label <b class='caret'></b></a>"; $ul_class="dropdown-menu" ; $li_class="" ; $style="nav"; $showlevel=6; $dropdown='dropdown'; echo sp_get_menu("main",$effected_id,$filetpl,$foldertpl,$ul_class,$li_class,$style,$showlevel,$dropdown); ?>
		...
		<ul class="nav pull-right" id="main-menu-user">
			<li class="dropdown user login">
	            ...
	            <img src="/cmfx/tpl/simplebootx//Public/images/headicon.png" class="headicon"/>
			...
			<div class="tc-box">
	        	...
	        	<div class="comment-ranking">
	        		...
	        		<?php if(is_array($last_comments)): foreach($last_comments as $key=>$vo): ?><div class="comment-ranking-inner">
	                        ...
	                        <a href="/cmfx/<?php echo ($vo["url"]); ?>#comment<?php echo ($vo["id"]); ?>">查看原文</a>
			        	...
			        	<dl class="dl-horizontal">
				            <dt>
					            <a class="img-wraper" href="<?php echo U('article/index',array('id'=>$vo['tid']));?>">
					            	<?php if(empty($smeta['thumb'])): ?><img src="/cmfx/tpl/simplebootx/Public/images/default_tupian4.png" class="img-responsive" alt="<?php echo ($vo["post_title"]); ?>"/>
									<?php else: ?> 
...
<!-- Le javascript
	...
	$(function(){
		...
		$.post("<?php echo U('user/index/is_login');?>",{},function(data){
			if(data.status==1){
				if(data.user.avatar){
					$("#main-menu-user .headicon").attr("src",data.user.avatar.indexOf("http")==0?data.user.avatar:"/cmfx/data/upload/avatar/"+data.user.avatar);
				}
