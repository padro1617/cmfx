      ...
      <table class="table table-bordered">
        ...
        <tr>
          <td>
			...
			<?php if(empty($smeta['thumb'])): ?><img src="/cmfx/statics/images/icon/upload-pic.png" id='thumb_preview' width='135' height='113' style='cursor:hand' />
			<?php else: ?>
            ...
            <input type="button"  class="btn" onclick="$('#thumb_preview').attr('src','/cmfx/statics/images/icon/upload-pic.png');$('#thumb').val('');return false;" value="取消图片">
            </div>
			</td>
        </tr>
        <tr>
...
<script type="text/javascript" src="/cmfx/statics/js/content_addtop.js"></script>
<script type="text/javascript"> 
$(function () {
